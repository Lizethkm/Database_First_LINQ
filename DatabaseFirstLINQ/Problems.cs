...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemOne()
        {
            ...
            var usersList = _context.Users.ToList().Count();
        ...
        private void ProblemThree()
        {
            ...
            var productsList = _context.Products.Where(p => p.Price > 150);
        ...
        private void ProblemFour()
        {
            ...
            var productsNameList = _context.Products.Where(p => p.Name.Contains("s"));

            foreach (Product product in productsNameList)
            {
        ...
        private void ProblemFive()
        {
            ...
            var userRegistrationList = _context.Users.Where(u => u.RegistrationDate < d);

            foreach (User user in userRegistrationList)
            {
        ...
        private void ProblemSix()
        {
            ...
            var registrationList = _context.Users.Where(u => u.RegistrationDate > start && u.RegistrationDate < end);

            foreach (User user in registrationList)
            {
                Console.WriteLine(user.Email + "  " + user.RegistrationDate);
            }
        ...
        private void ProblemTen()
        {
            ...
            var user = _context.UserRoles.Include(u => u.User).Include(ur => ur.Role).Where(u => u.RoleId == 2).Select(u => u.UserId);
            
            var shoppingCart = _context.ShoppingCarts;
            var products = shoppingCart.Include(u => u.User).Include(p => p.Product).Where(u => user.Contains(u.UserId));
        ...
        private void ProblemFourteen()
        {
            ...
            var userId = _context.Users.Where(u => u.Email == "david@gmail.com").Select(u => u.Id).SingleOrDefault();
            var productId = _context.Products.Where(p => p.Name == "iPhone 13 Pro Max").Select(p => p.Id).SingleOrDefault();
        ...
        private void ProblemTwenty()
        {
            ...
            var odaUser = _context.Users.Where(_u => _u.Email == "oda@gmail.com").SingleOrDefault();
